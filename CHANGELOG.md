...
- Document offline-first stale-while-revalidate as the recommended usage:
  render local data first, throttle hosted refresh attempts, replace state only
  on success, and keep package-upgrade mode for fully offline apps.
